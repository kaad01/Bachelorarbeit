...
from CBAM.src.models.models.save_dev.resnet_cbam_cifar10 import ResNetCBAM50
...
class Combine(nn.Module):
    def __init__(self):
        ...
        self.resnetCBAM = ResNetCBAM50()
        self.resnetCBAM.linear= nn.Linear(100352, 300)
...
if __name__ == '__main__':
    ...
    torch.save(model.state_dict(),"saved_models/model_cbam_" + timestamp)
