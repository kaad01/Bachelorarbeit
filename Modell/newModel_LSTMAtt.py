...
from pytorch_attention_mechanism.models import AttnLSTM

""" Modell does not work properly """
...
class Combine(nn.Module):
    def __init__(self):
        ...
        self.lstm = AttnLSTM(input_size=300, hidden_size=256, num_layers=3)
    ...
    def forward(self, x):
        ...
        r_out, hidden= self.lstm(r_in,hidden)
...
if __name__ == '__main__':
    ...
    for f in footage_paths:
        ...
        weight = dataWeight[c_name]
        class_paths[c] += [(f,c)] * weight
